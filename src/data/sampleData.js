...
export const SCHEMA = {
  ...
  tables: [
    { 
      ...
      rows: [
        ['Medical Insurance', 'Carrier name Group:', '1-xxx-xxx-xxxx\nwww.website.com'],
        ['Health Savings Account (HSA)', 'Vendor name', '1-xxx-xxx-xxxx\nwww.website.com'],
        ['Health Reimbursement Arrangement (HRA)', 'Vendor name', '1-xxx-xxx-xxxx\nwww.website.com'],
        ['Flexible Spending Accounts (FSAs)', 'Vendor name', '1-xxx-xxx-xxxx\nwww.website.com'],
        ['Employee Assistance Program (EAP)', 'Vendor name', '1-xxx-xxx-xxxx\nwww.website.com'],
        ['Dental Insurance', 'Carrier name Group:', '1-xxx-xxx-xxxx\nwww.website.com'],
        ['Vision Insurance', 'Carrier name Group:', '1-xxx-xxx-xxxx\nwww.website.com'],
        ['Life and AD&D Insurance', 'Carrier name Group:', '1-xxx-xxx-xxxx\nwww.website.com'],
        ['Disability Insurance', 'Carrier name Group:', '1-xxx-xxx-xxxx\nwww.website.com'],
        ['401(k) Retirement Savings', 'Vendor name', '1-xxx-xxx-xxxx\nwww.website.com'],
        ['Family Support', 'Vendor name', '1-xxx-xxx-xxxx\nwww.website.com'],
      ]
    },
    { 
      id: 'benefits-summary', 
